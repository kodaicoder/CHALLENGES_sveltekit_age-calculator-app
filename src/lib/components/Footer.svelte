...
<div class=" fixed bottom-0 right-0 z-20 bg-white rounded-full not-prose">
	<!-- <div class="relative"> -->
	<button
	...
	{#if showLabel}
		<div
			transition:fade
			class="footerLabel absolute w-72 md:w-max p-4 right-20 top-1/2 -translate-y-1/2 bg-blue-500 text-white rounded-lg"
		>
			<p class="m-0">
				Challenge by <a
					href="https://www.frontendmentor.io/"
					target="_blank"
					class=" underline underline-offset-2">Frontend Mentor</a
				>. Coded by
				<a
